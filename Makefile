...
GAMEPROJECTFILE =/media/bat/ExternalBat/Ubuntu/Projects/Unreal/FPS 4.16/FPS.uproject
...
TARGETS = \
	...
	FPS-Linux-Test  \
	FPS \
	FPSEditor-Linux-Debug  \
	FPSEditor-Linux-DebugGame  \
	FPSEditor-Linux-Shipping  \
	FPSEditor-Linux-Test  \
	FPSEditor\
	configure
...
FPS-Linux-Debug:
	 $(PROJECTBUILD) FPS Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

FPS-Linux-DebugGame:
	 $(PROJECTBUILD) FPS Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

FPS-Linux-Shipping:
	 $(PROJECTBUILD) FPS Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

FPS-Linux-Test:
	 $(PROJECTBUILD) FPS Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

FPS:
	 $(PROJECTBUILD) FPS Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)

FPSEditor-Linux-Debug:
	 $(PROJECTBUILD) FPSEditor Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

FPSEditor-Linux-DebugGame:
	 $(PROJECTBUILD) FPSEditor Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

FPSEditor-Linux-Shipping:
	 $(PROJECTBUILD) FPSEditor Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

FPSEditor-Linux-Test:
	 $(PROJECTBUILD) FPSEditor Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

FPSEditor:
	 $(PROJECTBUILD) FPSEditor Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)
